...
2. Review [docs/environment-setup.md](docs/environment-setup.md) for setup help
3. Open a GitHub issue for problems or questions
4. Review [docs/project-roadmap.md](docs/project-roadmap.md) for project status
