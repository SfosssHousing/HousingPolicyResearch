# Embedded JavaScript templates<br/> [![Known Vulnerabilities](https://snyk.io/test/npm/ejs/badge.svg?style=flat)](https://snyk.io/test/npm/ejs)
...
1. For the same reason, `include`s do not work unless you use an `include callback`. Here is an example:
