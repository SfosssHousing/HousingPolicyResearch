...
| `docs/environment-setup.md` | Hands-on setup and verification steps for local/CI environments. | Includes forward and reverse connection tests plus remediation tips. |
