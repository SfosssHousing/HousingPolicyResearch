...
2. **Research Recipe** – Complete the step sequence end-to-end.
3. **Drafting** – Apply Template pattern for memos, briefs, reports.
4. **Alternatives Gate** – Evaluate options before locking recommendations.
5. **QA Gate** – Run Fact Check List on every claim.
6. **Automation Hook** – Use Output Automater to emit CSVs or scripts for repeatable steps.
7. **Flipped Interaction** – Ask for missing inputs early.
8. **Approval → Version Bump → Export** – Apply Template + Context Manager.
...
2. Works Cited
3. Appendices (ROI models, charts, legal templates)
4. 1-Pager Summary
5. 2-Page Briefing Memo
6. Slide Deck
7. Annotated Comments Log
