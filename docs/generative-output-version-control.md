...
2. Add entry to this tracking document with:
   - File path and creation method
   - Original creation and verification dates
   - Quality assessment
   - Verification notes
3. Update the Version Control Status Summary table
4. Open PR with `documentation` label
...
2. Update "Last update" date in this tracking document
3. Add verification notes documenting what was changed and why
4. Update quality assessment if applicable
5. Open PR with clear description of changes
6. Request human review if substantive changes made

### Deprecating Generative Outputs
When superseding or removing generative content:
1. Add deprecation notice to the file header
2. Link to replacement content if applicable
3. Update status in this tracking document
4. Do not delete from Git; preserve in history
5. Update cross-references in other documentation
