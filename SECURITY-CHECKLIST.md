...
- [ ] **OpenAI - GET NEW KEY**
  ...
  - **Status:** ___________
  - **New Key (first 10 chars):** _________________
...
- [ ] **All keys revoked** (Date: _________)
- [ ] **All new keys obtained** (Date: _________)
- [ ] **GitHub Secrets configured** (Date: _________)
- [ ] **Setup script tested** (Date: _________)
- [ ] **Git history verified clean** (Date: _________)
...
3. Open a GitHub issue with label `security`
