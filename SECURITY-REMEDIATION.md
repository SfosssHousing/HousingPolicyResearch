...
2. Find the key starting with `sk-proj-6ya8D...`
3. Click the ❌ icon to delete it
4. Click "Create new secret key"
5. **Save the new key** – You'll need it in Step 3
...
2. Under "API Access" section, revoke the key
3. Request a new one
4. **Save the new key**
...
2. Request that the exposed token be revoked (include the key above)
3. Request a new API key for NYC legislative data
4. **Save the new key**
