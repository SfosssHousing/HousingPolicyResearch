...
- `Capstone alias` – Legacy export slated for conversion into structured markdown (see docs for remediation tasks).
...
For additional context on automation scripts, secret management, and cross-platform workflows, see [docs/integration-plan.md](docs/integration-plan.md).
