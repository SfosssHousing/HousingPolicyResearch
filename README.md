...
1. Review the [Environment Integration and Documentation Plan](docs/integration-plan.md) and the step-by-step [Environment Setup Guide](docs/environment-setup.md) for platform-specific setup steps and verification commands.
