...
1. **Briefing_Memo_Exec_v1_20251226.md**
...
1. **NYC_Housing_Subsidy_Ops_Tasks_Workplan.csv**
...
1. **ROI_Financial_Model_15Yr_Projection.csv**
...
1. Review ROI_Financial_Model base case scenario (Year 15 row)
1. Check legal feasibility in Master_Policy_Report Section 4

### For Policy Deep-Dive (4-6 hours)

1. Review Master_Policy_Report in full (sections 1-5)
1. Analyze ROI model with CFO team (all 3 scenarios)
1. Conduct legal risk review (Section 4 + referenced case law)
1. Map stakeholders using Section 5

### For Project Management (ongoing)

1. Import NYC_Housing_Subsidy_Ops_Tasks_Workplan into Notion/Trello
1. Assign owners + due dates for each phase
1. Use artifact column to track deliverables
1. Weekly status meetings against milestone dates

### For Public Communication (post-approval)

1. Extract key numbers from ROI model
1. Use 1-page summary from Briefing Memo
1. Reference research library for evidence base
1. Coordinate with HPD/NYCHA communications teams
